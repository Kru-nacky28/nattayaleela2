...
class GameApp {
  ...
  printAnalyticsReport() {
    try {
      ...
      // โหลดฟอนต์ Sarabun เข้าระบบสำหรับการพิมพ์แบบ TH SarabunPSK
      if (!document.getElementById('font-sarabun-print')) {
        const fontLink = document.createElement('link');
        fontLink.id = 'font-sarabun-print';
        fontLink.rel = 'stylesheet';
        fontLink.href = 'https://fonts.googleapis.com/css2?family=Sarabun:ital,wght@0,400;0,600;0,700;1,400&display=swap';
